  ...
  return (
    ...
    >
      ...
      <spotLight
        ...
        shadow-bias={-0.0001}
      />
      <spotLight position={[-5, 2, -2]} angle={0.5} penumbra={1} intensity={5} color="#00E5FF" />
      <pointLight position={[0, -5, 2]} intensity={1} color="#C8102E" />
      ...
      <EffectComposer>
        <N8AO aoRadius={0.5} intensity={1} screenSpaceRadius halfRes color="#000000" />
